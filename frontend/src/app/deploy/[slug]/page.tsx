...
import { deployApp, getZones, getOfferings } from '@/lib/api'
import { use } from 'react'
import type { CloudStackZone, CloudStackOffering } from '@/types'
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <button
        ...
        disabled={loading || loadingResources || !selectedZone || !selectedOffering}
